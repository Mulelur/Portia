...
import img from "../../assets/portia_1.jpeg";
import { AboutMe } from "../../components";
import { DownloadCVButton } from "../../components/buttons";
import cv from "../../assets/cv/portia_cv.pdf";
import letter from "../../assets/cv/Tintswalo Portia Mabunda_letter.pdf";
    ...
    <AboutMe>
      <AboutMe.Container>
        ...
        <AboutMe.Column>
          ...
          <AboutMe.Heading4>
            Hello! My Name is Tintswalo Portia Mabunda.
          </AboutMe.Heading4>
          <AboutMe.Text>
